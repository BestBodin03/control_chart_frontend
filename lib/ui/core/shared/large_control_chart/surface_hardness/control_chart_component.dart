...
class ControlChartComponentLarge extends StatelessWidget implements ChartComponent {
      ...
      child: Column(
        children: [
          Expanded(
            child: LineChart(
              LineChartData(
                gridData: buildGridData(1,1,1),
                titlesData: buildTitlesData(1,1,1),
