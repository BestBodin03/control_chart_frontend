...
class ControlChartTemplateSmall extends StatefulWidget {
  ...
  @override
  State<ControlChartTemplateSmall> createState() => _ControlChartTemplateState();
}

class _ControlChartTemplateState extends State<ControlChartTemplateSmall> {
  // ---------- utils ----------
