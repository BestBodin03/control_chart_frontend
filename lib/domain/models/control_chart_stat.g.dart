...
part of 'control_chart_stat.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ControlChartStat _$ControlChartStatFromJson(Map<String, dynamic> json) =>
    ControlChartStat(
      numberOfSpots: (json['numberOfSpots'] as num).toInt(),
      average: (json['average'] as num).toDouble(),
      mrAverage: (json['MRAverage'] as num).toDouble(),
      controlLimitIChart: ControlLimitIChart.fromJson(
        json['controlLimitIChart'] as Map<String, dynamic>,
      ),
      sigmaIChart: SigmaIChart.fromJson(
        json['sigmaIChart'] as Map<String, dynamic>,
      ),
      controlLimitMRChart: ControlLimitMRChart.fromJson(
        json['controlLimitMRChart'] as Map<String, dynamic>,
      ),
    );

Map<String, dynamic> _$ControlChartStatToJson(ControlChartStat instance) =>
    <String, dynamic>{
